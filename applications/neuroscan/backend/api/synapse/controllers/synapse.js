 ...
 module.exports = {
   async find(ctx) {
     ...
     entities = entities.map(entity => {
      ...
      return ({
         ...entity,
         name: entity.position === 'pre' ? `<b>pre-${entity.neuronPre?.uid}-${entity.type}</b>-post${postNeuronPart}${neuronsPostPart}${synapseSection}` : `pre-${entity.neuronPre?.uid}-${entity.type}-<b>post${postNeuronPart}</b>s${neuronsPostPart}${synapseSection}`,
       })});
