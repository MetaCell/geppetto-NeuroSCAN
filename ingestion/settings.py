...
CONTACTS_XLS = 'contacts.xlsx'
CONTACTS_XLS_NEURON_A_COL = 'Neuron1'
CONTACTS_XLS_NEURON_B_COL = 'Neuron2'
CONTACTS_XLS_WEIGHT_COL = 'Weight'

CPHATE_XLS = 'cphate.xlsx'
CPHATE_REQUIRED_COLUMN = 'Neuron'
CPHATE_ITERATION_COLUMN_PREFIX = 'Iter'

SYNAPSE_PRE_POSITION_TYPE = 'pre'
SYNAPSE_POST_POSITION_TYPE = 'post'

PROMOTER_FOLDER = 'promoters'
PROMOTER_XLS = 'promoters.xlsx'
...
PROMOTER_SHEET1_OTHER_CELLS_COLUMN = "OTHER CELLS (lineage status unknown)"
...
PROMOTER_SHEET2_LINEAGE_COLUMN = "Lineage Name"
...
PROMOTER_SHEET2_REQUIRED_COLUMNS = [PROMOTER_SHEET2_NEURON_COLUMN, PROMOTER_SHEET2_LINEAGE_COLUMN,
                                    PROMOTER_SHEET2_LOCATION_COLUMN]
